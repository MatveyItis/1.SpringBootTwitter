...
import ru.itis.maletskov.springboottwitter.controllers.MessageController;
...
public class MessageControllerTest {
    ...
    public void mainPage() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("//div[@id=\"navbarSupportedContent\"]/div").string("danis"));
    }
    ...
    public void addMessageToList() throws Exception {
        ...
        this.mockMvc.perform(multipart)
                ...
                .andExpect(xpath("//div[@id='message-list']/div[@data-id=10]/div/i").string("#some tag"));
    }
}
